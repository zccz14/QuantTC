...
namespace QuantTC.Indicators.Generic
{
    ...
    public static partial class X
    {
        ...
        /// <returns></returns>
        public static IEnumerable<Indicator> FollowingIndicators(this Indicator This) =>
            This.Followers.OfType<Indicator>();
        ...
        public static int Impaction(this Indicator This) => This.FollowingIndicators().Sum(i => i.Impaction()) +
                                                            This.Followers.Count(v => !(v is Indicator)) + 1;
    }
}